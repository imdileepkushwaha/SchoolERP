...
function erpPageModule(string $page): ?string {
    $map = [
        ...
        'student_import.php' => 'students', 'student_promote.php' => 'students', 'student_promote_advanced.php' => 'students',
        'student_id_card.php' => 'students', 'student_documents.php' => 'students', 'classes.php' => 'students',
        ...
        'teacher_view.php' => 'teachers', 'teacher_timetable.php' => 'teachers',
