...
if (!function_exists('numberWords')) {
...
if (!function_exists('dateInWords')) {
...
$classTeacherSigUrl = ($classTeacher && !empty($classTeacher['signature'])) ? schoolBrandingUrl($classTeacher['signature'], 'portal') : '';
